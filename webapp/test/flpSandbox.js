		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CatalogodeProdutos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CatalogodeProdutos-display": {
								"semanticObject": "CatalogodeProdutos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ovly.catalogo_produtos",
									"url": sap.ui.require.toUrl("ovly/catalogo_produtos")
								}
							}
						}
					}
